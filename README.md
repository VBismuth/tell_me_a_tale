...
Though, for TMT, I want to make it into a complete and self-hosted language with a FFI support that is both interpreted and compiled (using C or QBE backend).
...
- [ ] Base structure for the language
- [ ] Expressions
- [ ] Functions
- [ ] Terminal I/O
- [ ] Interpreter
